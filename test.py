...
from mcp_tools import get_mcp_tools_list, get_raw_tavily_search
...
def test_tavily_search_tool():
    ...
    try:
        ...
        # Get the raw implementation (not the @tool wrapper)
        raw_search = get_raw_tavily_search()
        result = raw_search(query=query, max_results=3)
